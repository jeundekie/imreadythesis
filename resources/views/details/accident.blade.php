...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/home" class="brand-link">
        <img src="/images/loaders/logo.png" alt="MCDRRMO" class="brand-image img-circle elevation-3"
        style="opacity: .8">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
              ...
              <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name='incidentlocation' placeholder="Incident Location" value="{{$result->incidentlocation}}" readonly>
                    </div>
                    <!-- /.form-group -->
                </div>
                <!-- /.col -->
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name='incidentid' placeholder="Incident Type" value="{{$result->incident}}" readonly>      
                    </div>
                    <!-- /.form-group -->
                    <div class="form-group">
        ...
        <form  action="{{ action('CrudController@insertaccdetails')}}" method="post" enctype="multipart/form-data" >
          @csrf
          <input type="hidden" class="form-control" name='roadid' id="roadid" placeholder="Accident ID" value ="{{$result->roadid}}" readonly>
          @endforeach
          <div class="card card-default">
          <div class="card-header">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" placeholder="Please enter name" class="form-control" id="victimname" name="victimname">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select name="assesment" id="assesment" class="form-control">
            ...
            <div class="row">
              <div class="col-12 col-sm-12">
                <div class="form-group">
                        ...
                        <textarea class="form-control"  id="descriptions"  name="descriptions" rows="2" placeholder="Enter ..."></textarea>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
