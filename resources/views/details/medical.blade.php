  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- SELECT2 EXAMPLE -->
        <form  action="{{action('AccidentController@insertaccident')}}" method="post" enctype="multipart/form-data">
          @csrf
        <div class="card card-default">
          <div class="card-header">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="mapcenter" role="tabpanel" aria-labelledby="mapcenter-tab">
                  ...
                  <input type="hidden" id="roadid" name="roadid" value="{{$r->roadid}}">
                    ...
                    <input type="hidden" id="patientid" name="patientid" value="1">
                    <input type="hidden" id="incidentid" name="incidentid" value="1">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <div class="row">
                       ...
                       <div class="col-md-4">
                           <div class="form-group">
                               <label class="col-md-12">Illness</label>
                               <input class="form-control" id="illness" name="illness" required>
                           </div>
                       </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="col-md-12">Brief Medical History</label>
                                <textarea class="form-control" id="medhis" name="medhis" required></textarea>
                            </div>
                        </div>
                       ...
                       <div class="col-md-4 whereto">
                        <div class="form-group">
                            ...
                            <input class="form-control where" type="text" id="whereto "name="whereto" value="{{ old('whereto')}}" />
                       ...
                       <div class="col-md-2 timedeath">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="deathdate" name="deathdate" value="<?php $d = strtotime("today"); echo date("m-d-Y", $d) ?>"/>
                        </div>
                       </div>
