  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- SELECT2 EXAMPLE -->
        <form  action="{{action('AccidentController@obdetails')}}" method="post" enctype="multipart/form-data">
          @csrf
        <div class="card card-default">
          <div class="card-header">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="mapcenter" role="tabpanel" aria-labelledby="mapcenter-tab">
                  ...
                  <input type="hidden" id="roadid" name="roadid" value="{{$r->roadid}}">
                    ...
                    <input type="hidden" id="patientid" name="patientid" value="3">
                    <input type="hidden" id="incidentid" name="incidentid" value="3">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <div class="row">
                       ...
                       <div class="col-md-4">
                           <div class="form-group">
                               <label class="col-md-12">Pain Scale</label>
                                <input type="text" class="form-control" id="painscale" name="painscale" placeholder="0-1 Scale Your Pain" required>
                           </div>
                       </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                            <label class="col-md-12">LMP</label>
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                          <label class="col-md-12">AOG</label>
                          <input type="text" class="form-control" id="aog" name="aog" placeholder="Weeks Being Pregnant" required>
                      </div>
                  </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                            <label class="col-md-12">E Due Date</label>
                            <input type="date" class="form-control" id="edd" name="edd" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                          <label class="col-md-12">APGAR</label>
                          <input type="text" class="form-control" id="apgarscore" name="apgarscore" required>
                      </div>
                  </div>
