  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              @foreach($getcen as $cen)
             <h1>{{$cen->centername}} Information</h1>
            @endforeach
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" name="example1" class="table table-bordered table-striped">
                 ...
                 <tbody>
                 @foreach($getinfo as $dent)
                  <tr>
                    <td>{{$dent->namedonate}}</td>
                    <td>{{$dent->description}}</td>
                    <td>{{$dent->redate}}</td>
                  </tr>
                @endforeach
                  </tbody>
        ...
        <div class="row">
            <div class="col-12">
                <a href="/add" class="btn btn-danger">Back</a>
            </div>
        </div>
      </div>
      <!-- /.container-fluid -->
