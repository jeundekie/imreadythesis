                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <table id="example1" name="example1" class="table table-bordered table-striped">
                     ...
                     <tbody>
                      @foreach($kuhadonasyon as $kuhas)
                      <tr>
                      <td>{{$kuhas->centername}}</td>
                      <td>{{$kuhas->name}}</td>
                      <td>{{$kuhas->namedonate}}</td>
                      <td>{{$kuhas->reliefcategory}}</td>
                      <td>{{$kuhas->description}}</td>
                      <td>{{$kuhas->redate}}</td>
                      <td><img src="{{$kuha->images}}" style="width: 50px; height:50px;"></td>  
                      <td>
                        <button class="btn btn-info" type="button" ><i class="fas fa-eye"></i></button>
        ...
        <table id="alltable" name="alltable" class="table table-bordered table-striped">
         ...
         <tbody>
          ...
          <tr>
            ...
            <td>
              <button class="btn btn-info hidemodal" type="button" data-toggle="modal" data-target="#checkmodal" ><i class="fas fa-eye"></i></button>
      ...
      <div class="modal-body">
        ...
        @foreach($getmedicine as $med)
          <tr>
            ...
            <td>
              <button class="btn btn-info medicine" type="button" data-toggle="modal" data-target="#checkmodal" ><i class="fas fa-eye"></i></button>
              <button class="btn btn-success" type="button" ><i class="fas fa-check"></i></button>
            </td>    
          </tr>
         @endforeach
...
<div class="modal fade" id="checkmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">All the Received Information</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <div class="showmedmodal">
        <table id="checkmedtable" name="checkmedtable" class="table table-bordered table-striped">
          <thead>
          <tr>
            <th>Center Name</th>
            <th>Who Request</th>
        ...
        <div class="foodshow">
        <table id="foodcheck" name="foodcheck" class="table table-bordered table-striped">
          <thead>
          <tr>
            <th>Center Name</th>
            <th>Who Request</th>
    ...
    <!-- Add Donation Received By MCDRRMO Modal -->
      ...
      <form action="{{action('ReportController@sendgift')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="dategive" name="dategive" required>
            </div>
            </div>
