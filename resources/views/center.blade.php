          ...
          <div class="col-12">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">No. of Evacuation Center Per Barangay</h3>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Ayuda Counting Information</h3>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                  <!--<button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times"></i></button> -->
                </div>
              ...
              <div class="card-body">
                <table id="example1" name="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th>Center Name</th>
                    <th>No. Recived  of Ayuda From MCDRRMO</th>
                
                  </tr>
                  </thead>
                 <tbody>
                  @foreach($results2 as $ad)
                  <tr>
                    <td>{{$ad->lugarmc}}</td>
                    <td>{{$ad->galingmc}}</td>  
                  </tr>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Good Samaritan Donation</h3>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                  <!--<button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times"></i></button> -->
                </div>
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example9" name="example9" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>Center Name</th>
                    <th>No. Recived Donation Individual</th>
