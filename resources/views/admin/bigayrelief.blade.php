...
<head> 
  ...
  <title>MCDRRMO | Evacuation Information</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            <button class="btn btn-info"  data-toggle="modal" data-target="#exampleModal">Add Record</button>
          </div>
        </div>
        <br>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Disaster Information</h3>
              ...
              <div class="card-body">
                <table id="example1" name="example1" class="table table-bordered table-striped">
                 ...
                 <tbody>
                  ...
                  <tr>
                    <td>{{$ad->disastertype}}</td>
                    <td>{{$ad->descriptions}}</td>  
                    <td>{{$ad->recordate}}</td>
                    <td>{{$ad->remarks}}</td>    
                  </tr>
                  @endforeach
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Record Disaster</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      <form action="{{action('DisasterController@insdisast')}}" method="POST">
        @csrf
      <input type="hidden" name="id" value="{{Auth::user()->id}}">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label class="col-md-12">Disaster Type:</label>
                <select name="disasterid" id="disasterid" class="form-control">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <textarea name="descriptions" id="des" class="form-control"></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <input type="date" name="recordate" id="da" class="form-control">
              <input type="hidden" name="recordyear" value="<?php echo date("Y"); ?>" class="form-control">
              </div>
            </div>
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="remarks" id="dos" class="form-control">
              </div>
            </div>
          </div>
      </div>
